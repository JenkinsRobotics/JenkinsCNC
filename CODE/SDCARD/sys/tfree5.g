...
G53 G1  X-638 Y-600 F4000
G53 G1 X-638 Y-680 F3000

; SWIPE INTO PART HOLDER
G53 G1 X-638  Y-680 Z-50 F3000
G53 G1 X-638  Y-724 Z-50 F1000

; DROP TOOL AND SWIPE OUT
G4 S1			          						; pause 1 second
M42 P1 S1.0           							; turn ON output 1 (TOOL CHANGER UNLOCK) (RANGE : 0 to 255 or 0.0 to 1.0) 
G4 S1			          						; pause 1 second
G53 G1 Z-2 F1000 								; Raise Spindle

; RETURN TO PART HOLDER PERCH
G53 G1 X-638  Y-600 F3000
G53 G1 X-700 Y-600 F4000						; Use machine coordinates Moved To Specified Perch Location 

M291 P"TOOL 5 DROP OFF." R"Success" S1          ; screen message